...
<body>
	<div class="navigation container-fluid" style="background-color:#ECECEC;display: flex;">
		<div style="width: 90%;">
          ...
          <li><a href="srmevents.php">SRM Events</a></li>
				</ul>
			</div>
...
<div class="col-sm-8">
  <div class="posting" style="margin-left: 7%;width: 60%;">
               ...
               <button onclick="document.getElementById('write-post').style.display='block'" style="border:0.2px solid black;padding:5% 70% 5% 70%;background-color: white;">Write here</button>
</div>
</div>
    ...
    <div class="card-body">
      ...
      <a href="#" class="btn btn-primary">Read More</a>
    	...
    	<div class="col-sm-3">
    		...
    		<h3>New & Upcoming Events</h3><hr style="border: 0.5px solid LightGray">
    		<div class="category"><a href="">Event 1</a></div>
    		<div class="category"><a href="">Event 2</a></div>
    		<div class="category"><a href="">Event 3</a></div>
    		<div class="category"><a href="">Event 4</a></div>
    		<div class="category"><a href="">Event 5</a></div>
    		<div class="category"><a href="">Event 6</a></div>
    		<br>
    	</div>
  	</div>
